...
console.log('[VolleyStat] v0.1.10 loaded');

var STORAGE_KEY = 'volleystat_v010';
var UI_MODE_KEY = 'volleystat_ui_mode';
var DEFAULT_MATCHES = ['Day 1 M1','Day 1 M2','Day 1 M3','Day 2 M1','Day 2 M2','Day 2 M3','Day 3 M1','Day 3 M2','Day 3 M3'];
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  function getExportContextLabel(){
    ...
    var team = activeTeam();
    var match = matchSelect.value || (team && team.matches && team.matches[0]) || 'Day 1 M1';
    var set = setSelect.value || '1';
    var day = (daySelect && daySelect.value) ? daySelect.value : 'Day 1';
    if (view === 'set') return day + ' ' + match.replace(day+' ','') + ' Set ' + set;
  ...
  function buildEditGrid(){
    ...
    if (!team) return;
    var players = (team.players || []).slice().sort(sortPlayers);
    var match = matchSelect.value || (team.matches[0] || 'Day 1 M1');
    var set = setSelect.value || '1';
