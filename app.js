...
function closeTeams() {
  ...
  if (teamsBackdrop) {
    teamsBackdrop.addEventListener('click', function (e) {
  ...
  function derived(playerId) {
    ...
    var serveInPct = safePct(serveIn, serveAtt);
    ...
    return { serveAtt: serveAtt, serveAvg: serveAvg, pressurePct: (uiMode === 'player') ? serveInPct : pressurePct, , aceCount: aceCount, acePct: acePct, passAtt: passAtt, passAvg: passAvg, hitAtt: hitAtt, hitAvg: hitAvg, kills: kills, killPct: killPct };
  }
